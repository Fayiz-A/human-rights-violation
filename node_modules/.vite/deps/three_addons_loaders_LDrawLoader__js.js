...
var LDrawLoader = class extends Loader {
  constructor(manager) {
    ...
    this.missingColorMaterial = new MeshStandardMaterial({ color: 16711935, roughness: 0.3, metalness: 0 });
    this.missingColorMaterial.name = "Missing material";
    this.missingEdgeColorMaterial = new LineBasicMaterial({ color: 16711935 });
    this.missingEdgeColorMaterial.name = "Missing material - Edge";
    this.missingConditionalEdgeColorMaterial = new LDrawConditionalLineMaterial({ fog: true, color: 16711935 });
